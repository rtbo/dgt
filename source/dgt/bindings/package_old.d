/// Former bindings system is described hereunder.
/// It worked well but made apparently bad use of CTFE as compile time
/// went above the roof with this system and it also made dub/dmd run out of
/// memory pretty often on a 4Gb system.
/// usage was like this:
/// ---
/// ...
...
/// alias CairoLoader = SymbolLoader!(
///     ...
...
/// void load()
/// {
///     cairoLoader.load(["libcairo.so", "libcairo.so.2"]);
/// }
/// ---
/// The code leaves apart some details one can find the git history.
/// Last commit with this system is tagged former_bindings.
/// I choose to keep this module in the code such as it is not forgotten.
module dgt.bindings.package_old;
//module dgt.bindings;
