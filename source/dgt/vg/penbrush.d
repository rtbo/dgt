...
final class Pen
{
    ...
    @property const(Paint) paint() const { return _paint; }
    @property void paint(Paint paint) { _paint = _paint; }
...
final class Brush
{
    ...
    this(in FillRule rule, Paint paint)
    {
        _rule = rule;
        _paint = paint;
    }
    ...
    @property const(Paint) paint() const { return _paint; }
    @property void paint(Paint paint) { _paint = paint; }
